# Generated by Django 3.2.4 on 2022-11-05 06:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backgroun_image', models.ImageField(null=True, upload_to='')),
                ('avatar', models.ImageField(null=True, upload_to='')),
                ('excel', models.FileField(null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_image_urls', models.ImageField(null=True, upload_to='')),
                ('area', models.CharField(max_length=30, null=True)),
                ('communication_style', models.JSONField()),
                ('public', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='labo.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.CharField(choices=[('Store', 'コンビニ決済'), ('Card', 'コンビニ決済'), ('QR', 'バーコード決済')], max_length=30)),
                ('payment_deadline', models.CharField(max_length=30)),
                ('schedule', models.CharField(max_length=30)),
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='labo.item')),
        ...
        migrations.AddField(
            model_name='user',
            name='categories',
            field=models.ManyToManyField(to='labo.Category'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
